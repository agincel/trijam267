...
var file
@export_file var uvAnimationFile
#var uvAnimationFile = "res://objects/Roboy/uvAnimation.txt"
...
func _process(delta):
	elapsedTime = Time.get_ticks_msec() / 1000.0	#must be float in order to get precise time
	var updateUVs = false
